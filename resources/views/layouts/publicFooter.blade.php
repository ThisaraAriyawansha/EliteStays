                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-4">
                            <div class="footer-widget">
                                <img src="assets/img/BoomBitz.png" class="img-footer" alt="">
                                <div class="footer-add">
                                    <p>We make your dream more beautiful & enjoyful with lots of happiness.</p>
                                </div>
                                <div class="foot-socials">
                                    <ul>
                                        <li><a href="https://www.facebook.com/boombitz.official"><i class="fa-brands fa-facebook"></i></a></li>
                        ...
                        <div class="col-lg-2 col-md-4">
                            <div class="footer-widget">
                                ...
                                <ul class="footer-menu">
                                    ...
                                    <li><a href="JavaScript:Void(0);">Hire in the Sri Lanka</a></li>
                ...
                <div class="container">
                    <div class="row align-items-center justify-content-between">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6">
                            <p class="mb-0 text-white"> 2025 © All Rights Reserved | BoomBitz | Designed & Developed by Silicon Radon Networks (Pvt) Ltd.</p>
                        </div>

                        <div class="col-xl-6 col-lg-6 col-md-6 text-white">
                            <ul class="p-0 d-flex justify-content-start justify-content-md-end text-start text-md-end m-0 ">
                                <li><a href="#" class="text-white">Terms of services</a></li>
                                <li class="ms-3 text-white"><a href="#" class="text-white">Privacy Policies</a></li>
                                <li class="ms-3 text-white"><a href="#" class="text-white">Cookies</a></li>
                            </ul>
                        </div>
