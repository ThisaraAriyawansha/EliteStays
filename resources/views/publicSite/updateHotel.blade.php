...
<head>
    ...
    <title>Update Hotel - EliteStays</title>
...
<body>
                    ...
                    <div class="col-lg-8 mx-auto">
                        <div class="card shadow-sm">
                            <div class="card-body">
                                ...
                                <form action="{{ route('customer.saveHotel') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="mb-3">
                                    ...
                                    <div class="upload-container">
                                        ...
                                        @if ($hotel->image_path)
                                            <div class="current-image">
                                                ...
                                                <img src="{{ asset($hotel->image_path) }}" alt="Current Hotel Image" style="max-width: 200px; border-radius: 8px;">
                                            </div>
                                        @endif
                                        <div class="upload-box" id="imageUploadBox">
                                            ...
                                            <div class="upload-text">
                                                Drag & drop a new hotel image here or click to browse
                                            </div>
                                            <div class="upload-hint">
                                                Allowed formats: JPG, JPEG, PNG (Max 5MB)
                                            </div>
                                            <input type="file" id="hotelImages" name="image_path" class="upload-input" accept="image/png, image/jpeg, image/jpg">
                                        </div>
                                    ...
                                    <div class="upload-container">
                                        ...
                                        @if ($hotel->logo_path)
                                            <div class="current-image">
                                                ...
                                                <img src="{{ asset($hotel->logo_path) }}" alt="Current Hotel Logo" style="max-width: 150px; border-radius: 8px;">
                                            </div>
                                        @endif
                                        <div class="upload-box" id="logoUploadBox">
                                            ...
                                            <div class="upload-text">
                                                Drag & drop a new logo here or click to browse
                                            </div>
                                            <div class="upload-hint">
                                    ...
                                    <div class="text-end">
                                        <a href="{{ route('customerManageHotel') }}" class="btn btn-secondary me-2">Cancel</a>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        setupUploadBox(imageUploadBox, hotelImagesInput, imagePreview, false);
        ...
        function updatePreview(input, previewContainer, allowMultiple) {
            ...
            Array.from(filesToShow).forEach((file, index) => {
                ...
                if (file.size > (allowMultiple ? 5 * 1024 * 1024 : 2 * 1024 * 1024)) {
                    const errorDiv = document.createElement('div');
                    errorDiv.className = 'alert alert-danger mt-2';
                    errorDiv.textContent = `File "${file.name}" exceeds size limit (${allowMultiple ? '5MB' : '2MB'}).`;
                    previewContainer.appendChild(errorDiv);
                    return;
                }
