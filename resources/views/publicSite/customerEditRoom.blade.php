...
<head>
    ...
    <title>Edit Room - EliteStays</title>
            ...
            <div class="profile-main">
                <div class="profile-card">
                    ...
                    <div class="profile-header">
                        <h1 class="profile-title">Edit Room - {{ $room->name }}</h1>
                    </div>

                    <form action="{{ route('customerUpdateRoom') }}?id={{ $room->id }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="price_per_night" id="price_per_night" class="form-control" value="{{ old('price_per_night', $room->price_per_night) }}" step="0.01" required>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="adult_price" id="adult_price" class="form-control" value="{{ old('adult_price', $room->adult_price) }}" step="0.01" required>
                                    @error('adult_price')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="children_price" id="children_price" class="form-control" value="{{ old('children_price', $room->children_price) }}" step="0.01" required>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="total_rooms" id="total_rooms" class="form-control" value="{{ old('total_rooms', $room->total_rooms) }}" required>
                                    @error('total_rooms')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="breakfast_price" id="breakfast_price" class="form-control" value="{{ old('breakfast_price', $room->breakfast_price) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <select name="status_id" id="status_id" class="form-control" required>
                                ...
                                @foreach ($statuses as $status)
                                    <option value="{{ $status->id }}" {{ old('status_id', $room->status_id) == $status->id ? 'selected' : '' }}>{{ $status->name }}</option>
                                @endforeach
                            </select>
                            @error('status_id')
                                <small class="text-danger">{{ $message }}</small>
                        ...
                        <div class="form-group">
                            ...
                            @if ($room->image_path)
                                <div>
                                    <img src="{{ asset($room->image_path) }}" alt="{{ $room->name }}" class="current-image" onerror="this.src='{{ asset('assets/images/placeholder-room.jpg') }}';">
                                </div>
                            @endif
