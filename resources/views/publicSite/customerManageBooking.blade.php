...
<head>
    ...
    <title>Manage Bookings - EliteStays</title>
    <link href="{{ asset('assets/css/bootstrap.min.css') }}" rel="stylesheet">
    <link href="{{ asset('assets/css/fontawesome.css') }}" rel="stylesheet">
    <link href="{{ asset('assets/css/style.css') }}" rel="stylesheet">
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&display=swap" rel="stylesheet">
    <style>
        /* Reuse the same styles as provided in your original HTML */
        body {
            ...
            <div class="profile-main">
                <div class="profile-card">
                    ...
                    <div class="profile-header">
                        <h1 class="profile-title">Manage Bookings</h1>
                    </div>
                    ...
                    @if ($bookings->isEmpty())
                        <div class="empty-state">
                            ...
                            <h3 class="empty-text">You haven't made any bookings yet</h3>
                                ...
                                <tbody>
                                    @foreach ($bookings as $booking)
                                        <tr>
                                            ...
                                            <td>{{ $booking->email }}</td>
                                            <td>{{ $booking->status->name ?? 'N/A' }}</td>
                                            <td>
                                                        <div style="display: flex; gap: 10px;">
                                                            <a href="{{ route('customerViewBooking') }}?id={{ $booking->id }}" class="btn-update">
