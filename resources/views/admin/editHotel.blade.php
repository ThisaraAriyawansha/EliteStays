...
<div class="main-content">
    <div class="main-content-inner">
        <div class="main-content-wrap">
            ...
            <div class="wg-box">
                <form id="editHotelForm" class="form-new-product form-style-1" method="POST" action="{{ route('hotels.update', $hotel->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <fieldset class="name">
                        ...
                        <input class="mb-10" type="text" placeholder="Enter Name" name="name" id="name" value="{{ old('name', $hotel->name) }}" required>
                    </fieldset>

                    <fieldset class="address">
                        <div class="body-title mb-10">Address <span class="tf-color-1">*</span></div>
                        <input class="mb-10" type="text" placeholder="Enter Address" name="address" id="address" value="{{ old('address', $hotel->address) }}" required>
                    </fieldset>

                    <fieldset class="city">
                        <div class="body-title mb-10">City <span class="tf-color-1">*</span></div>
                        <input class="mb-10" type="text" placeholder="Enter City" name="city" id="city" value="{{ old('city', $hotel->city) }}" required>
                    </fieldset>

                    <fieldset class="description">
                        <div class="body-title mb-10">Description <span class="tf-color-1">*</span></div>
                        <input class="mb-10" type="text" placeholder="Enter Description" name="description" id="description" value="{{ old('description', $hotel->description) }}" required>
                    </fieldset>

                    <fieldset>
                        <div class="body-title mb-10">Current Image</div>
                        <img src="{{ asset($hotel->image_path) }}" alt="{{ $hotel->name }}" style="width: 100px; height: 100px; object-fit: cover; margin-bottom: 10px;">
                    </fieldset>
                    ...
                    <fieldset>
                        <div class="body-title mb-10">Current Logo</div>
                        @if ($hotel->logo_path)
                            <img src="{{ asset($hotel->logo_path) }}" alt="{{ $hotel->name }} Logo" style="width: 100px; height: 100px; object-fit: cover; margin-bottom: 10px;">
                        @else
                    ...
                    <fieldset>
                        <div class="body-title">Upload New Logo (Optional, JPG, JPEG, PNG only)</div>
                        <div class="upload-image flex-grow">
                            <div class="item up-load">
